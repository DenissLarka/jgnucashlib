...
public class GenInvc {
  ...
  private static String paybleAcctID = "55711b4e6f564709bf880f292448237a"; // Root
  // Account:Fremdkapital:Lieferanten:sonstige
  ...
  protected void kernel() throws Exception {
    ...
    try {
      ...
      System.err.println("Income account:     " + "Code: " + incAcct.getCode() + ", " + "Type: " + incAcct.getType()
          + ", " + "Name: '" + incAcct.getQualifiedName() + "'");
    ...
    try {
      ...
      System.err.println("Expenses account:     " + "Code: " + expAcct.getCode() + ", " + "Type: " + expAcct.getType()
          + ", " + "Name: '" + expAcct.getQualifiedName() + "'");
  ...
  private GnucashWritableCustomerInvoice doCustomer(GnucashWritableFileImpl gcshFile) throws NoOwnerFoundException,
    ...
    GnucashWritableCustomerInvoice invc = gcshFile.createWritableCustomerInvoice(number, cust, incAcct, recvblAcct,
    ...
    entry1.setAction(bundle.getMessage("ACTION_JOB"));
    ...
    entry2.setAction(bundle.getMessage("ACTION_HOURS"));
    ...
    entry3.setAction(bundle.getMessage("ACTION_MATERIAL"));
  ...
  private GnucashWritableVendorBill doVendor(GnucashWritableFileImpl gcshFile) throws NoOwnerFoundException,
    ...
    GnucashWritableVendorBill bll = gcshFile.createWritableVendorBill(number, vend, expAcct, payblAcct, dateOpen,
        datePost, dateDue);
  ...
  private GnucashWritableJobInvoice doJob_cust(GnucashWritableFileImpl gcshFile)
    ...
    GnucashWritableJobInvoice invc = gcshFile.createWritableJobInvoice(number, job, incAcct, recvblAcct, dateOpen,
        datePost, dateDue);
    invc.setDescription("Generated by GenInv " + LocalDateTime.now().toString());
  ...
  private GnucashWritableJobInvoice doJob_vend(GnucashWritableFileImpl gcshFile)
    ...
    GnucashWritableJobInvoice invc = gcshFile.createWritableJobInvoice(number, job, incAcct, payblAcct, dateOpen,
        datePost, dateDue);
    invc.setDescription("Generated by GenInv " + LocalDateTime.now().toString());
