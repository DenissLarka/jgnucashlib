...
import org.gnucash.xml.GnucashObject;
...
public class GnucashFileImpl implements GnucashFile {
	...
	protected GnucashInvoiceEntry createInvoiceEntry(
			final GncV2.GncBook.GncGncEntry jwsdpInvoiceEntry) throws JAXBException {
	...
	protected GnucashCustomerImpl createCustomer(
			final GncV2.GncBook.GncGncCustomer jwsdpCustomer) throws JAXBException {
	...
	protected GnucashTransactionImpl createTransaction(
			final GncTransaction jwsdpTransaction) throws JAXBException {
