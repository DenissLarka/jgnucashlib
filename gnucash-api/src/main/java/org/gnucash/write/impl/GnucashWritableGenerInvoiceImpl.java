 ...
 */
public class GnucashWritableGenerInvoiceImpl extends GnucashGenerInvoiceImpl implements GnucashWritableGenerInvoice {
   ...
   */
  protected GnucashWritableGenerInvoiceImpl(final GnucashWritableFileImpl file, final String number,
      final GnucashCustomer cust, final GnucashAccountImpl incomeAcct, final GnucashAccountImpl receivableAcct,
      final LocalDate openedDate, final LocalDate postDate, final LocalDate dueDate) throws WrongOwnerTypeException {
    super(
        createCustomerInvoice_int(file, number, cust, false, incomeAcct, receivableAcct, openedDate, postDate, dueDate),
        file);
  }
  ...
  protected GnucashWritableGenerInvoiceImpl(final GnucashWritableFileImpl file, final String number,
      ...
      final LocalDate openedDate, final LocalDate postDate, final LocalDate dueDate) throws WrongOwnerTypeException {
    super(createVendorBill_int(file, number, vend, false, expensesAcct, payableAcct, openedDate, postDate, dueDate),
        file);
  }
   ...
   */
  protected GnucashWritableGenerInvoiceImpl(final GnucashWritableFileImpl file, final String number,
      final GnucashGenerJob job, final GnucashAccountImpl incExpAcct, final GnucashAccountImpl payblRecvblAcct,
      final LocalDate openedDate, final LocalDate postDate, final LocalDate dueDate) throws WrongOwnerTypeException {
    super(createJobInvoice_int(file, number, job, false, incExpAcct, payblRecvblAcct, openedDate, postDate, dueDate),
        file);
  }
   ...
   */
  public GnucashWritableGenerInvoiceEntry createGenerEntry(final GnucashAccount acct,
    ...
    GnucashWritableGenerInvoiceEntryImpl entry = new GnucashWritableGenerInvoiceEntryImpl(this, acct, quantity,
        singleUnitPrice);
   ...
   * create and add a new entry.
   */
  public GnucashWritableCustomerInvoiceEntry createCustInvcEntry(final GnucashAccount acct,
      final FixedPointNumber singleUnitPrice, final FixedPointNumber quantity)
      throws WrongInvoiceTypeException, TaxTableNotFoundException {

    GnucashWritableCustomerInvoiceEntryImpl entry = new GnucashWritableCustomerInvoiceEntryImpl(
        new GnucashWritableCustomerInvoiceImpl(this), acct, quantity, singleUnitPrice);
  ...
  public GnucashWritableCustomerInvoiceEntry createCustInvcEntry(final GnucashAccount acct,
    ...
    if (taxTabName.equals("")) {
      // no taxes
      return createCustInvcEntry(acct, singleUnitPrice, quantity);
    } else {
      ...
      return createCustInvcEntry(acct, singleUnitPrice, quantity, taxTab);
    }
  }
   ...
   * create and add a new entry.
   */
  public GnucashWritableVendorBillEntry createVendBillEntry(final GnucashAccount acct,
      final FixedPointNumber singleUnitPrice, final FixedPointNumber quantity)
      throws WrongInvoiceTypeException, TaxTableNotFoundException {

    GnucashWritableVendorBillEntryImpl entry = new GnucashWritableVendorBillEntryImpl(
        new GnucashWritableVendorBillImpl(this), acct, quantity, singleUnitPrice);
  ...
  public GnucashWritableVendorBillEntry createVendBillEntry(final GnucashAccount acct,
    ...
    if (taxTabName.equals("")) {
      // no taxes
      return createVendBillEntry(acct, singleUnitPrice, quantity);
    } else {
      GCshTaxTable taxTab = getFile().getTaxTableByName(taxTabName);
      LOGGER.debug("createVendBillEntry: Found tax table with name '" + taxTabName + "': '" + taxTab.getId() + "'");
      return createVendBillEntry(acct, singleUnitPrice, quantity, taxTab);
    }
  }
   ...
   * create and add a new entry.
   */
  public GnucashWritableJobInvoiceEntry createJobInvcEntry(final GnucashAccount acct,
      final FixedPointNumber singleUnitPrice, final FixedPointNumber quantity)
    ...
    GnucashWritableJobInvoiceEntryImpl entry = new GnucashWritableJobInvoiceEntryImpl(
        new GnucashWritableJobInvoiceImpl(this), acct, quantity, singleUnitPrice);
   ...
   */
  protected static GncV2.GncBook.GncGncInvoice createCustomerInvoice_int(final GnucashWritableFileImpl file,
      final String number, final GnucashCustomer cust, final boolean postInvoice, final GnucashAccountImpl incomeAcct,
      final GnucashAccountImpl receivableAcct, final LocalDate openedDate, final LocalDate postDate,
    ...
    // date opened
    {
      ...
      ZonedDateTime openedDateTime = ZonedDateTime.of(LocalDateTime.of(openedDate, LocalTime.MIN),
    ...
    if (postInvoice) {
      ...
      postCustomerInvoice_int(file, fact, invc, invcGUID, number, cust, incomeAcct, receivableAcct,
   ...
   * instead of calling this method!
   *
   * @param accountToTransferMoneyFrom e.g. "Forderungen aus Lieferungen und Leistungen "
   */
  protected static GncV2.GncBook.GncGncInvoice createVendorBill_int(final GnucashWritableFileImpl file,
      final String number, final GnucashVendor vend, final boolean postInvoice, final GnucashAccountImpl expensesAcct,
      final GnucashAccountImpl payableAcct, final LocalDate openedDate, final LocalDate postDate,
      final LocalDate dueDate) throws WrongOwnerTypeException {
    ...
    if (postInvoice) {
      ...
      postVendorBill_int(file, fact, invc, invcGUID, number, vend, expensesAcct, payableAcct, new FixedPointNumber(0),
          postDate, dueDate);
    } else {
   ...
   * @param accountToTransferMoneyTo e.g. "Forderungen aus Lieferungen und Leistungen "
   */
  protected static GncV2.GncBook.GncGncInvoice createJobInvoice_int(final GnucashWritableFileImpl file,
      final String number, final GnucashGenerJob job, final boolean postInvoice, final GnucashAccountImpl incExpAcct,
      final GnucashAccountImpl recvblPayblAcct, final LocalDate openedDate, final LocalDate postDate,
      final LocalDate dueDate) throws WrongOwnerTypeException {
    ...
    if (postInvoice) {
      ...
      postJobInvoice_int(file, fact, invc, invcGUID, number, job, incExpAcct, recvblPayblAcct, new FixedPointNumber(0),
          postDate, dueDate);
    } else {
  ...
  public void postCustomerInvoice(final GnucashWritableFile file, GnucashWritableCustomerInvoice invc,
      final GnucashCustomer cust, final GnucashAccount incomeAcct, final GnucashAccount receivableAcct,
      final LocalDate postDate, final LocalDate dueDate) throws WrongInvoiceTypeException, WrongOwnerTypeException {
    ...
    String postTrxID = postCustomerInvoice_int((GnucashWritableFileImpl) file, fact, getJwsdpPeer(), invc.getId(),
        invc.getNumber(), cust, (GnucashAccountImpl) incomeAcct, (GnucashAccountImpl) receivableAcct, amount, postDate,
        dueDate);
    LOGGER.info("postCustomerInvoice: Customer invoice " + invc.getId() + " posted with Tranaction ID " + postTrxID);
  }

  public void postVendorBill(final GnucashWritableFile file, GnucashWritableVendorBill bll, final GnucashVendor vend,
      final GnucashAccount expensesAcct, final GnucashAccount payableAcct, final LocalDate postDate,
    ...
    String postTrxID = postVendorBill_int((GnucashWritableFileImpl) file, fact, getJwsdpPeer(), bll.getId(),
        bll.getNumber(), vend, (GnucashAccountImpl) expensesAcct, (GnucashAccountImpl) payableAcct, amount, postDate,
        dueDate);
    LOGGER.info("postVendorBill: Vendor bill " + bll.getId() + " posted with Tranaction ID " + postTrxID);
  }

  public void postJobInvoice(final GnucashWritableFile file, GnucashWritableJobInvoice invc, final GnucashGenerJob job,
      final GnucashAccount incomeAcct, final GnucashAccount receivableAcct, final LocalDate postDate,
      final LocalDate dueDate) throws WrongInvoiceTypeException, WrongOwnerTypeException {
    ...
    String postTrxID = postJobInvoice_int((GnucashWritableFileImpl) file, fact, getJwsdpPeer(), invc.getId(),
        invc.getNumber(), job, (GnucashAccountImpl) incomeAcct, (GnucashAccountImpl) receivableAcct, amount, postDate,
        dueDate);
  ...
  private static String postCustomerInvoice_int(final GnucashWritableFileImpl file, ObjectFactory fact,
      GncV2.GncBook.GncGncInvoice invcRef, final String invcGUID, String invcNumber, final GnucashCustomer cust,
      final GnucashAccountImpl incomeAcct, final GnucashAccountImpl receivableAcct, final FixedPointNumber amount,
      final LocalDate postDate, final LocalDate dueDate) throws WrongOwnerTypeException {
    // post account
    {
    ...
    // date posted
    {
      ...
      ZonedDateTime postDateTime = ZonedDateTime.of(LocalDateTime.of(postDate, LocalTime.MIN), ZoneId.systemDefault());
    ...
    String acctLotID = "(unset)";
    {
      ...
      GncAccount.ActLots.GncLot newLot = createInvcPostLot_Customer(file, fact, invcGUID, invcNumber, receivableAcct,
          cust);
    ...
    String postTrxID = null;
    {
      ...
      GnucashWritableTransaction postTrx = createPostTransaction(file, fact, invcGUID,
          GnucashGenerInvoice.TYPE_CUSTOMER, invcNumber, cust.getName(), incomeAcct, receivableAcct, acctLotID, amount,
          amount, postDate, dueDate);
  ...
  private static String postVendorBill_int(final GnucashWritableFileImpl file, ObjectFactory fact,
      GncV2.GncBook.GncGncInvoice invcRef, final String invcGUID, String invcNumber, final GnucashVendor vend,
      final GnucashAccountImpl expensesAcct, final GnucashAccountImpl payableAcct, final FixedPointNumber amount,
      final LocalDate postDate, final LocalDate dueDate) throws WrongOwnerTypeException {
    // post account
    {
      GncV2.GncBook.GncGncInvoice.InvoicePostacc postAcct = fact.createGncV2GncBookGncGncInvoiceInvoicePostacc();
    ...
    String acctLotID = "(unset)";
    {
      ...
      GncAccount.ActLots.GncLot newLot = createBillPostLot_Vendor(file, fact, invcGUID, invcNumber, payableAcct, vend);
    ...
    String postTrxID = null;
    {
      ...
      GnucashWritableTransaction postTrx = createPostTransaction(file, fact, invcGUID, GnucashGenerInvoice.TYPE_VENDOR,
          invcNumber, vend.getName(), expensesAcct, payableAcct, acctLotID, amount, amount, postDate, dueDate);
      postTrxID = postTrx.getId();
      postTrxRef.setValue(postTrxID);
  ...
  private static String postJobInvoice_int(final GnucashWritableFileImpl file, ObjectFactory fact,
      GncV2.GncBook.GncGncInvoice invcRef, final String invcGUID, String invcNumber, final GnucashGenerJob job,
      final GnucashAccountImpl incExpAcct, final GnucashAccountImpl recvblPayblAcct, final FixedPointNumber amount,
      final LocalDate postDate, final LocalDate dueDate) throws WrongOwnerTypeException {
    // post account
    {
      GncV2.GncBook.GncGncInvoice.InvoicePostacc postAcct = fact.createGncV2GncBookGncGncInvoiceInvoicePostacc();
    ...
    String acctLotID = "(unset)";
    {
      ...
      GncAccount.ActLots.GncLot newLot = createInvcPostLot_Job(file, fact, invcGUID, invcNumber, recvblPayblAcct, job);
    ...
    String postTrxID = null;
    {
      ...
      GnucashWritableTransaction postTrx = createPostTransaction(file, fact, invcGUID, job.getOwnerType(), invcNumber,
          job.getName(), incExpAcct, recvblPayblAcct, acctLotID, amount, amount, postDate, dueDate);
      postTrxID = postTrx.getId();
      postTrxRef.setValue(postTrxID);
   ...
   */
  private static GnucashWritableTransaction createPostTransaction(final GnucashWritableFileImpl file,
      final ObjectFactory factory, final String invcID, final String invcOwnerType, final String invcNumber,
      final String descr, final GnucashAccount fromAcct, // receivable/payable account
      final GnucashAccount toAcct, // income/expense account
      final String acctLotID, final FixedPointNumber amount, final FixedPointNumber quantity, final LocalDate postDate,
      final LocalDate dueDate) throws WrongOwnerTypeException {
    if (!invcOwnerType.equals(GCshOwner.TYPE_CUSTOMER) && !invcOwnerType.equals(GCshOwner.TYPE_VENDOR)) // sic, TYPE_JOB
    // not allowed
    // here
    {
    ...
    if (invcOwnerType.equals(GCshOwner.TYPE_CUSTOMER)) {
      split1.setAction(bundle.getMessage("ACTION_INVOICE"));
    } else if (invcOwnerType.equals(GCshOwner.TYPE_VENDOR)) {
      split1.setAction(bundle.getMessage("ACTION_BILL"));
    }
    ...
    if (invcOwnerType.equals(GCshOwner.TYPE_CUSTOMER)) {
      split2.setAction(bundle.getMessage("ACTION_INVOICE"));
    } else if (invcOwnerType.equals(GCshOwner.TYPE_VENDOR)) {
      split2.setAction(bundle.getMessage("ACTION_BILL"));
    }
    ...
    // add trans-date-due -slot
    {
      ...
      ZonedDateTime dueDateTime = ZonedDateTime.of(LocalDateTime.of(dueDate, LocalTime.MIN), ZoneId.systemDefault());
    ...
    // add trans-read-only-slot
    {
      ...
      value.setType("string");
      value.getContent().add(bundle.getMessage("INVC_READ_ONLY_SLOT_TEXT"));
  ...
  private static GncAccount.ActLots.GncLot createInvcPostLot_Customer(final GnucashWritableFileImpl file,
      final ObjectFactory factory, final String invcID, final String invcNumber, final GnucashAccountImpl postAcct,
      final GnucashCustomer cust) {
    return createInvcPostLot_Gener(file, factory, invcID, invcNumber, postAcct, GCshOwner.Type.CUSTOMER,
        GnucashGenerInvoice.TYPE_CUSTOMER, // second one is dummy
        cust.getId());
  }

  private static GncAccount.ActLots.GncLot createBillPostLot_Vendor(final GnucashWritableFileImpl file,
      final ObjectFactory factory, final String invcID, final String invcNumber, final GnucashAccountImpl postAcct,
      final GnucashVendor vend) {
    return createInvcPostLot_Gener(file, factory, invcID, invcNumber, postAcct, GCshOwner.Type.VENDOR,
        GnucashGenerInvoice.TYPE_VENDOR, // second one is dummy
        vend.getId());
  }

  private static GncAccount.ActLots.GncLot createInvcPostLot_Job(final GnucashWritableFileImpl file,
      final ObjectFactory factory, final String invcID, final String invcNumber, final GnucashAccountImpl postAcct,
      final GnucashGenerJob job) {
    return createInvcPostLot_Gener(file, factory, invcID, invcNumber, postAcct, GCshOwner.Type.JOB, job.getOwnerType(), // second
        // one
        // is
        // NOT
        // dummy
  ...
  private static GncAccount.ActLots.GncLot createInvcPostLot_Gener(final GnucashWritableFileImpl file,
      final ObjectFactory factory, final String invcID, final String invcNumber, final GnucashAccountImpl postAcct,
    ...
    // 2.1) add title-slot
    {
      ...
      if (ownerType1 == GCshOwner.Type.CUSTOMER) {
        contentStr = bundle.getMessage("ACTION_INVOICE");
      } else if (ownerType1 == GCshOwner.Type.VENDOR) {
        contentStr = bundle.getMessage("ACTION_BILL");
  ...
  protected void removeInvcEntry(final GnucashWritableGenerInvoiceEntryImpl impl)
    ...
    if (!getType().equals(TYPE_CUSTOMER) && !getType().equals(TYPE_JOB)) // ::CHECK
    {
  ...
  protected void removeBillEntry(final GnucashWritableGenerInvoiceEntryImpl impl)
    ...
    if (!getType().equals(TYPE_VENDOR) && !getType().equals(TYPE_JOB)) // ::CHECK
    {
      throw new WrongInvoiceTypeException();
    }
  ...
  protected void subtractJobEntry(final GnucashGenerInvoiceEntryImpl entry)
    ...
    } else if (entry.getGenerInvoice().getOwnerType(GnucashGenerInvoice.ReadVariant.VIA_JOB)
        .equals(GCshOwner.TYPE_VENDOR)) {
   ...
   */
  protected String getInvcPostAccountID(final GnucashGenerInvoiceEntryImpl entry) throws WrongInvoiceTypeException {
    if (!getType().equals(TYPE_CUSTOMER) && !getType().equals(TYPE_JOB)) {
      throw new WrongInvoiceTypeException();
    }
   ...
   * @return the AccountID of the Account to transfer the money from
   */
  protected String getBillPostAccountID(final GnucashGenerInvoiceEntryImpl entry) throws WrongInvoiceTypeException {
    if (!getType().equals(TYPE_VENDOR) && !getType().equals(TYPE_JOB)) {
      throw new WrongInvoiceTypeException();
    }
   ...
   * @return the AccountID of the Account to transfer the money from
   */
  protected String getJobPostAccountID(final GnucashGenerInvoiceEntryImpl entry) throws WrongInvoiceTypeException {
    if (!getType().equals(TYPE_JOB)) {
      throw new WrongInvoiceTypeException();
    }
   ...
   *
   */
  private void updateEntry(final GCshTaxTable taxTab, final boolean isTaxable, final FixedPointNumber sumExclTaxes,
      final FixedPointNumber sumInclTaxes, final String postAcctID) throws IllegalTransactionSplitActionException {
    LOGGER.debug(
        "GnucashInvoiceWritingImpl.updateEntry " + "isTaxable=" + isTaxable + " " + "post-acct=" + postAcctID + " ");
    ...
    if (isTaxable) {
      updateEntry_taxStuff(taxTab, sumExclTaxes, sumInclTaxes, postAcctID, postTrx);
    }
  ...
  private void updateEntry_taxStuff(final GCshTaxTable taxtable, final FixedPointNumber sumExclTaxes,
      final FixedPointNumber sumInclTaxes, final String postAcctID, GnucashWritableTransactionImpl postTrx) {
    ...
    LOGGER.debug("GnucashInvoiceWritingImpl.updateEntry_taxStuff " + "post-acct=" + postAcctID + " " + "tax-acct="
        + taxAcct.getQualifiedName() + " " + "entryTaxAmount=" + entryTaxAmount + " " + "#splits="
    ...
    for (GnucashTransactionSplit element : postTrx.getSplits()) {
      ...
      if (split.getAccountID().equals(taxAcct.getId())) {
        ...
        LOGGER.info("GnucashInvoiceWritingImpl.updateEntry_taxStuff " + "updated tax-split=" + split.getId() + " "
            + "of account " + split.getAccount().getQualifiedName() + " " + "to value " + split.getValue());

        postTransactionTaxUpdated = true;
        break;
      }
      LOGGER.debug("GnucashInvoiceWritingImpl.updateEntry_taxStuff " + "ignoring non-tax-split=" + split.getId() + " "
          + "of value " + split.getValue() + " " + "and account " + split.getAccount().getQualifiedName());
    }

    if (!postTransactionTaxUpdated) {
      GnucashWritableTransactionSplitImpl split = (GnucashWritableTransactionSplitImpl) postTrx
      ...
      split.setAction(bundle.getMessage("ACTION_INVOICE"));

      LOGGER.info("GnucashInvoiceWritingImpl.updateEntry_taxStuff " + "created new tax-split=" + split.getId() + " "
          + "of value " + split.getValue() + " " + "and account " + split.getAccount().getQualifiedName());
    }
  }
  ...
  private void updateNonTaxableEntry(final FixedPointNumber sumExclTaxes, final FixedPointNumber sumInclTaxes,
    ...
    for (GnucashTransactionSplit element : postTransaction.getSplits()) {
      ...
      if (split.getAccountID().equals(accountToTransferMoneyFrom)) {
        ...
        split.getJwsdpPeer().setSplitAction(bundle.getMessage("ACTION_INVOICE"));
