...
public class GnucashWritableJobInvoiceImpl extends GnucashWritableGenerInvoiceImpl
	...
	/**
	 * Called by
	 * ${@link GnucashWritableJobInvoiceEntryImpl#createCustInvoiceEntry_int(GnucashWritableJobInvoiceImpl, GnucashAccount, FixedPointNumber,
	 * FixedPointNumber)}.
	 *
	 ...
	 * CAUTION!
	 *
	 * @Override protected String getInvcPostAccountID(final GnucashGenerInvoiceEntryImpl entry) throws
	 * WrongInvoiceTypeException { throw new WrongInvoiceTypeException(); }
	 *
	 * @Override protected String getBillPostAccountID(final GnucashGenerInvoiceEntryImpl entry) throws
	 * WrongInvoiceTypeException { throw new WrongInvoiceTypeException(); }
	 */
