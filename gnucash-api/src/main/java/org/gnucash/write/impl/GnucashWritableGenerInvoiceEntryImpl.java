...
public class GnucashWritableGenerInvoiceEntryImpl extends GnucashGenerInvoiceEntryImpl
  ...
  private static GncV2.GncBook.GncGncEntry createGenerInvoiceEntryCommon(final GnucashWritableGenerInvoiceImpl invoice,
    ...
    entry.setEntryAction(bundle.getMessage("ACTION_HOURS"));
  ...
  public void setAction(final String action) {
    if (action != null && !action.equals(bundle.getMessage("ACTION_JOB"))
        && !action.equals(bundle.getMessage("ACTION_MATERIAL")) && !action.equals(bundle.getMessage("ACTION_HOURS"))) {
