 ...
 * <br/>
 * <p>
 * A CurrencyTable holds the translations from some currencies to one
 * base-currency of one specfic point in time (usually the current time).
 * </p>
 * <br/>
...
public class SimpleCurrencyTable implements Serializable {
  ...
  // LoggerFactory.getLogger(SimpleCurrencyTable.class);
   ...
   * {@link FixedPointNumber} that is to be multiplied with an ammount of that
   ...
   *         ammount of that currency to get the value in the base-currency.
   */
   ...
   *                            multiplied with an ammount of that currency to get
