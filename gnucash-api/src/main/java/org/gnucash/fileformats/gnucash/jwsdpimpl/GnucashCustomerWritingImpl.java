...
import org.gnucash.fileformats.gnucash.GnucashWritableCustomer;
import org.gnucash.fileformats.gnucash.GnucashWritableFile;
import org.gnucash.generated.Address;
import org.gnucash.generated.GncV2;
import org.gnucash.generated.ObjectFactory;
import org.gnucash.xml.impl.GnucashCustomerImpl;
...
public class GnucashCustomerWritingImpl extends GnucashCustomerImpl implements GnucashWritableCustomer {
	 ...
	 */
	protected GnucashCustomerWritingImpl(final GncV2.GncBook.GncGncCustomer jwsdpPeer, final GnucashFileWritingImpl file) throws JAXBException {
	 ...
	 *
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer#remove()
	 */
	public void remove() {
	 ...
	 */
	protected static GncV2.GncBook.GncGncCustomer createCustomer(final GnucashFileWritingImpl file, final String guid) throws JAXBException {
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer#setCustomerNumber(java.lang.String)
	 */
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer#setDiscount(java.lang.String)
	 */
	 ...
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer#setNotes(String)
	 */
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer#setName(java.lang.String)
	 */
	...
	/**
	 * @see org.gnucash.xml.GnucashCustomer#getAddress()
	 */
	@Override
	...
	/**
	 * @see org.gnucash.xml.GnucashCustomer#getShippingAddress()
	 */
	@Override
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer#getWritableAddress()
	 */
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer#getWritableShippingAddress()
	 */
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer#setAdress(org.gnucash.fileformats.gnucash.GnucashCustomer.ShippingAdress)
	 */
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer#setShippingAddress(Address)
	 */
	...
	public static class WritableAddressImpl extends GnucashCustomerImpl.AddressImpl implements GnucashWritableCustomer.WritableAddress {
		...
		/**
		 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer.WritableAddress#setAddressName(java.lang.String)
		 */
		...
		/**
		 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer.WritableAddress#setAddressLine1(java.lang.String)
		 */
		...
		/**
		 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer.WritableAddress#setAddressLine2(java.lang.String)
		 */
		...
		/**
		 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer.WritableAddress#setAddressLine4(java.lang.String)
		 */
		...
		/**
		 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer.WritableAddress#setTel(java.lang.String)
		 */
		...
		/**
		 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer.WritableAddress#setFac(java.lang.String)
		 */
		...
		/**
		 * @see org.gnucash.fileformats.gnucash.GnucashWritableCustomer.WritableAddress#setEmail(java.lang.String)
		 */
