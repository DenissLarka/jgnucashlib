...
import org.gnucash.fileformats.gnucash.*;
import org.gnucash.generated.*;
import org.gnucash.numbers.FixedPointNumber;
import org.gnucash.xml.*;
import org.gnucash.xml.impl.*;
...
//         propertyChange.firePropertyChange("modified", old, pModified);
	 ...
	 * @see GnucashFileImpl#setRootElement(org.gnucash.fileformats.gnucash.jwsdpimpl.generated.GncV2)
	 */
	@Override
	 ...
	 * @throws JAXBException on jaxb-problems
	 */
	protected GncTransaction.TrnSplits.TrnSplit createGncTransactionTypeTrnSplitsTypeTrnSplitType() throws JAXBException {
	 ...
	 * @throws JAXBException on jaxb-problems
	 */
	protected GncV2.GncBook.GncGncInvoice createGncGncInvoiceType() throws JAXBException {
	 ...
	 * @throws JAXBException on jaxb-problems
	 */
	protected GncV2.GncBook.GncGncEntry createGncGncEntryType() throws JAXBException {
	 ...
	 * @throws JAXBException on jaxb-problems
	 */
	protected GncV2.GncBook.GncGncCustomer createGncGncCustomerType() throws JAXBException {
	 ...
	 */
	@Override
	protected GnucashAccount createAccount(final GncAccount jwsdpAccount) throws JAXBException {
	 ...
	 */
	@Override
	protected GnucashInvoiceEntry createInvoiceEntry(final GncV2.GncBook.GncGncEntry jwsdpInvoiceEntry) throws JAXBException {
	 ...
	 */
	@Override
	protected GnucashCustomerImpl createCustomer(final GncV2.GncBook.GncGncCustomer jwsdpCustomer) throws JAXBException {
	 ...
	 */
	@Override
	protected GnucashTransactionImpl createTransaction(final GncTransaction jwsdpTransaction) throws JAXBException {
...
//                    }
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableFile#getTransactionByID(java.lang.String)
	 */
	@Override
	 ...
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableFile#getJobByID(String)
	 */
	@Override
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableFile#getWritableJobs()
	 */
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableFile#getWritableTransactions()
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableFile#createWritableTransaction()
	 */
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableFile#createWritableCustomer()
	 */
	...
	/**
	 * @see org.gnucash.fileformats.gnucash.GnucashWritableFile#createWritableAccount()
	 */
	...
	/* (non-Javadoc)
	 * @see org.gnucash.fileformats.gnucash.jwsdpimpl.GnucashFileImpl#getRootAccounts()
	 */
	@Override
