...
public interface GnucashFile extends GnucashObject {
   ...
   * @see #getUnpaidInvoicesForCustomer_viaJob(GnucashCustomer)
   */
  Collection<GnucashCustomerInvoice> getPaidInvoicesForCustomer_direct(GnucashCustomer cust)
      throws WrongInvoiceTypeException;
   ...
   * @see #getUnpaidInvoicesForCustomer_viaJob(GnucashCustomer)
   */
  Collection<GnucashJobInvoice> getPaidInvoicesForCustomer_viaAllJobs(GnucashCustomer cust)
      throws WrongInvoiceTypeException;
   ...
   * @see #getUnpaidInvoicesForCustomer_viaJob(GnucashCustomer)
   */
  Collection<GnucashCustomerInvoice> getUnpaidInvoicesForCustomer_direct(GnucashCustomer cust)
      throws WrongInvoiceTypeException;
   ...
   * @see #getUnpaidInvoicesForCustomer_viaJob(GnucashCustomer)
   */
  Collection<GnucashJobInvoice> getUnpaidInvoicesForCustomer_viaAllJobs(GnucashCustomer cust)
      throws WrongInvoiceTypeException;
