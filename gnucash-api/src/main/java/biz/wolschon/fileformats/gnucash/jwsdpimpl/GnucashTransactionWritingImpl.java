...
public class GnucashTransactionWritingImpl extends GnucashTransactionImpl implements GnucashWritableTransaction {
	...
	/**
	 * @see biz.wolschon.fileformats.gnucash.GnucashWritableTransaction#setDateEntered(LocalDateTime)
	 */
	...
	/**
	 * @see biz.wolschon.fileformats.gnucash.GnucashWritableTransaction#setDatePosted(LocalDateTime)
	 */
