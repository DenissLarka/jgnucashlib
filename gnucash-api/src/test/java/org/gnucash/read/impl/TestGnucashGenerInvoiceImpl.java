...
public class TestGnucashGenerInvoiceImpl {
	...
	public void testCust02_1() throws Exception {
		...
		Assert.assertEquals(
				((GnucashGenerInvoiceEntry) entrList.toArray()[0]).getId(), "92e54c04b66f4682a9afb48e27dfe397");
		Assert.assertEquals(
				((GnucashGenerInvoiceEntry) entrList.toArray()[1]).getId(), "3c67a99b5fe34387b596bb1fbab21a74");
	}
	...
	public void testCust04_1() throws Exception {
		...
		Assert.assertEquals(
				((GnucashTransaction) trxList.toArray()[0]).getId(), "29557cfdf4594eb68b1a1b710722f991");
	...
	public void testVend02_1() throws Exception {
		...
		entrList.addAll(invc.getGenerEntries());
		Assert.assertEquals(
				((GnucashGenerInvoiceEntry) entrList.toArray()[0]).getId(), "0041b8d397f04ae4a2e9e3c7f991c4ec");
	}
	...
	public void testVend02_2() throws Exception {
		...
		entrList.addAll(invc.getGenerEntries());
		Assert.assertEquals(
				((GnucashGenerInvoiceEntry) entrList.toArray()[1]).getId(), "513589a11391496cbb8d025fc1e87eaa");
		Assert.assertEquals(
				((GnucashGenerInvoiceEntry) entrList.toArray()[0]).getId(), "dc3c53f07ff64199ad4ea38988b3f40a");
	}
	...
	public void testVend04_2() throws Exception {
		...
		Collections.sort(trxList);
		Assert.assertEquals(
				((GnucashTransaction) trxList.toArray()[0]).getId(), "ccff780b18294435bf03c6cb1ac325c1");
