...
public class TestGnucashVendorBillImpl {
  ...
  public void test03_1() throws Exception {
    ...
    Assert.assertEquals(ConstTest.DIFF_TOLERANCE, 41.40,
        ((SpecInvoiceCommon) bllSpec).getAmountWithoutTaxes().doubleValue());
    ...
    Assert.assertEquals(ConstTest.DIFF_TOLERANCE, 41.40,
        ((SpecInvoiceCommon) bllSpec).getAmountWithTaxes().doubleValue());
  }
  ...
  public void test03_2() throws Exception {
    ...
    Assert.assertEquals(ConstTest.DIFF_TOLERANCE, 79.11,
        ((SpecInvoiceCommon) bllSpec).getAmountWithoutTaxes().doubleValue());
    ...
    Assert.assertEquals(ConstTest.DIFF_TOLERANCE, 94.14,
        ((SpecInvoiceCommon) bllSpec).getAmountWithTaxes().doubleValue());
  }
