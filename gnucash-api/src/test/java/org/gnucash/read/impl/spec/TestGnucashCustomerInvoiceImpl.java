...
public class TestGnucashCustomerInvoiceImpl {
  // private static Locale locale_de = new Locale("de", "DE");;
//  private static ApplicationMessages bundle = ApplicationMessages.getInstance(locale_de);
  ...
  public void test02_1() throws Exception {
    ...
    Assert.assertEquals(((GnucashCustomerInvoiceEntry) entrList.toArray()[0]).getId(),
        "92e54c04b66f4682a9afb48e27dfe397");
    Assert.assertEquals(((GnucashCustomerInvoiceEntry) entrList.toArray()[1]).getId(),
        "3c67a99b5fe34387b596bb1fbab21a74");
  }
  ...
  public void test03_1() throws Exception {
    ...
    Assert.assertEquals(ConstTest.DIFF_TOLERANCE, 1327.60,
