...
public class TestGnucashCustomerImpl {
  ...
  public void test02_1() throws Exception {
    ...
    Assert.assertEquals(((GnucashCustomerInvoice) cust.getPaidInvoices_direct().toArray()[0]).getId(),
        "d9967c10fdf1465e9394a3e4b1e7bd79");
    Assert.assertEquals(cust.getNofOpenInvoices(), 1);
    Assert.assertEquals(cust.getUnpaidInvoices_direct().size(), 1);
    Assert.assertEquals(((GnucashCustomerInvoice) cust.getUnpaidInvoices_direct().toArray()[0]).getId(),
        "6588f1757b9e4e24b62ad5b37b8d8e07");
  }
  ...
  public void test02_2() throws Exception {
    ...
    // assertEquals(
    // cust.getUnpaidInvoices(GnucashGenerInvoice.ReadVariant.DIRECT).toArray()[0].toString(),"[GnucashCustomerInvoiceImpl:
    // id: d9967c10fdf1465e9394a3e4b1e7bd79 customer-id (dir.): 5d1dd9afa7554553988669830cc1f696 invoice-number: 'R1730'
    // description: 'null' #entries: 0 date-opened: 2023-07-29]");
  }
