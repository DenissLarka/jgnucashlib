...
public class TestGCshTaxTableImpl {
  ...
  private static final String TAX_ACCT_ID = "1a5b06dada56466197edbd15e64fd425"; // Root
  ...
  public void test02_1_1() throws Exception {
    ...
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getAmount().doubleValue(), 19.0,
        ConstTest.DIFF_TOLERANCE);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getType(),
        GCshTaxTableEntry.TYPE_PERCENT);
  ...
  public void test03_1() throws Exception {
    ...
    Assert.assertEquals(taxTab.getEntries().size(), 1);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getAmount().doubleValue(), 7.0,
        ConstTest.DIFF_TOLERANCE);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getType(),
        GCshTaxTableEntry.TYPE_PERCENT);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getAccountID(), TAX_ACCT_ID);
  ...
  public void test04_1() throws Exception {
    ...
    Assert.assertEquals(taxTab.getEntries().size(), 1);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getAmount().doubleValue(), 20.0,
        ConstTest.DIFF_TOLERANCE);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getType(),
        GCshTaxTableEntry.TYPE_PERCENT);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getAccountID(), TAX_ACCT_ID);
  ...
  public void test05_1() throws Exception {
    ...
    Assert.assertEquals(taxTab.getEntries().size(), 1);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getAmount().doubleValue(), 10.0,
        ConstTest.DIFF_TOLERANCE);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getType(),
        GCshTaxTableEntry.TYPE_PERCENT);
    Assert.assertEquals(((GCshTaxTableEntry) taxTab.getEntries().toArray()[0]).getAccountID(), TAX_ACCT_ID);
